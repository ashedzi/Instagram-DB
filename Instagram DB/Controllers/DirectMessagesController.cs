...
namespace Instagram_DB.Controllers {
    public class DirectMessagesController : Controller {
        ...
        public DirectMessagesController(DirectMessageService directMessageService, InstagramDbContext context) {
        ...
        public IActionResult Index(int? userId) {
            ...
            var messages = _directMessageService.GetDirectMessages()
